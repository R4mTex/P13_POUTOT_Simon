# Generated by Django 4.2.2 on 2023-09-15 16:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stratOfUse', models.DateField()),
                ('endOfUse', models.DateField()),
                ...
                ('applicantSignature', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='applicant_signature', to='blog.signaturemodel')),
